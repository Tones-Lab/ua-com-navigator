...
- Dev: `npm run dev` at repo root runs backend + frontend workspaces. Scripts defined in [com-management/package.json](com-management/package.json).
- Backend dev/build/test: `npm run -w backend dev|build|test|lint` (see [com-management/backend/package.json](com-management/backend/package.json)).
- Frontend dev/build: `npm run -w frontend dev|build|lint` (see [com-management/frontend/package.json](com-management/frontend/package.json)).
